...
def train(argv=None):
    ...
    checkpoint_path = os.path.join('cnn_model_4_256_dim_64_1', 'model.ckpt')
    tensorboard_train_dir = 'tensorboard_cnn_4_256_dim_64_1/train'
    tensorboard_valid_dir = 'tensorboard_cnn_4_256_dim_64_1/valid'
